...
> ## The **TDD project** is a ruby project that uses a TDD (Test driven development) approach to check a Solver class and its corresponding methods.
...
<details>
  ...
  <ul>
    <li><p> <b>RSpec: </b> A ruby testing framework.</p></li>
  </ul>
</details>
...
```sh
  cd my-folder
  git clone https://github.com/david30-maker/tdd-project.git
```
...
- [ ] Create more class and methods using TDD approach.
...
Feel free to check the [issues page](https://github.com/david30-maker/tdd-project/issues).
...
We would like to thank the [Microverse team](https://www.microverse.org/) for allowing us to work on this TDD ruby project.
